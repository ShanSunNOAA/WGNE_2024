...
if (nplot==3) i1=i0; j1=j0-hgt*2-dh;   titl0='NHX H500'; end
if (nplot==4) i1=i0+w+dw;              titl0='SHX H500'; end
if (nplot==5) i1=i0; j1=j0-hgt*3-dh*2; titl0='NHX Precip'; end
if (nplot==6) i1=i0+w+dw;              titl0='SHX Precip'; end
...
y(1:5,1)=h01(nplot-2,1:5);
y(1:5,2)=h02(nplot-2,1:5);
y(1:5,3)=h03(nplot-2,1:5); 
elseif  (nplot==5) || (nplot==6)  
y(1:5,1)=p01(nplot-4,1:5);
y(1:5,2)=p02(nplot-4,1:5);
y(1:5,3)=p03(nplot-4,1:5); end
 ...
 if (nplot == 6) legend('NoAer','ClimAer','ProgAer'); end
 grid
